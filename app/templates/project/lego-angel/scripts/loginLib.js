var lego-angel = lego-angel || {};

lego-angel.LoginLib = (function() {
  var password = '',
    username = '',
    cookieUrl =  lego-angel.config.LOGIN.urlPath + '/DFAUTH/slod/DFServletXML',
    tsecUrl =  lego-angel.config.LOGIN.urlPath + '/ASO/TechArchitecture/grantingTickets/V02',
    sessionUrl =  lego-angel.config.LOGIN.urlPath + '/ENPP/enpp_mult_web_mobility_02/sessions/v1';
  ...
  function doLogin(username, pass) {
    return new Promise(function(resolve, reject) {
      ...
      function _getTsec() {
        ...
        _doCall(attrs,
          function(responseData, req){
            ...
            _getSession();
            lego-angel.config.LOGIN.logged = true;
          },
          function(responseData) {
            reject(Error(responseData));
            _getSession();
      ...
      if(!lego-angel.config.LOGIN.logged) {
